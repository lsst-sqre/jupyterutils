...
class LSSTConfig(metaclass=Singleton):
    ...
    def eliotify_root_logger(self, level):
        ...
        rootlogger.debug(
            "Setting default log level to '{}'".format(level))
    ...
    def load_from_environment(self):
        ...
        self.base_passwd_file = (
            os.getenv('BASE_PASSWD_DEFINITION_FILE') or
            '/opt/lsst/software/jupyterhub/base-files/passwd')
        self.base_group_file = (
            os.getenv('BASE_GROUP_DEFINITION_FILE') or
            '/opt/lsst/software/jupyterhub/base-files/group')
